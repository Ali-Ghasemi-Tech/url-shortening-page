  ...
  return (
        <div className='pb-20 relative flex justify-center'>
          ...
          <img className=' absolute -right-32 img' src={Hero_img} alt="" /> 
            ...
            <div className='flex justify-center absolute -bottom-16 w-full  items-center bg-gray-800 bg-[url(../images/bg-shorten-desktop.svg)] bg-no-repeat h-0 px-[3em] py-[4em] bg-cover rounded-xl'>
              <Input/>
            </div>
        </div>
  )
